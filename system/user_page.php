...
/* Make the card title consistent across both cards */
.card-title {
   font-size: 1.25rem; /* Same font size for both headings */
   font-weight: bold; /* Bold text for heading */
   margin-bottom: 15px; /* Space below heading */
}

/* Ensure consistent text inside the card */
.card-text {
   font-size: 1rem; /* Standard text size */
   margin-bottom: 15px; /* Space between text and button */
}

/* Buttons to ensure uniformity */
.btn {
   width: 100%; /* Make buttons take the full width of the card */
}

/* Ensure equal size for both cards (height and width) */
.col-md-6 {
   display: flex;
...
/* If you need specific media queries for responsiveness */
@media (max-width: 768px) {
   ...
   .card-title {
      font-size: 1.15rem; /* Slightly smaller font size on mobile */
   }

   .btn {
      font-size: 1rem; /* Make buttons a bit larger on mobile */
   }
}
